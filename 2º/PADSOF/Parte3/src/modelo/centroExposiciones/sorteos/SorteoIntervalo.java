...
public class SorteoIntervalo extends Sorteo{
    private LocalDateTime fechaIncio;
    private LocalDateTime fechaFin;

    protected SorteoIntervalo(){}
    public SorteoIntervalo(int numeroEntradas, int numGanadores, LocalDateTime inicioInscripcion, LocalDateTime finInscripcion, int penalizacion, Exposicion expo, LocalDateTime fechaIncio, LocalDateTime fechaFin){
    ...
    public boolean canjearCodigo(Cliente c, LocalDateTime fechaHora){
        ...
        if (fechaHora.isBefore(fechaIncio) || fechaHora.isAfter(fechaFin)) 
            return false;
     ...
     */
    @Override
    public void reservarEntradasSorteo(int numEntradasReservar){

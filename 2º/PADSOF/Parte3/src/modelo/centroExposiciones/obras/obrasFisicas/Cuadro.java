...
public class Cuadro extends ObraFisica {
    
    private String tecnica;
    protected Cuadro(){}
    public Cuadro(String autor, String titulo, int anio, String descripcion, Seguro seguro, Dimension dimensiones, Rango temp, Rango humedad, String duenio, Estado estado ,String tecnica){
    ...
    public boolean comparar(String filtro, String filtrado){
        if (filtro.equalsIgnoreCase("Obra") && filtrado.equalsIgnoreCase("Cuadro")) {
            return true;
        }
        return false;  
    }
    ...
    public static Cuadro parse(String[] str){
        ...
        Cuadro cuadro = new Cuadro(str[3], str[2], Integer.parseInt(str[4]),str[5], seguro, dimensiones, rangoTemp, rangoHumd, str[1], estado_act, str[8]);
        return cuadro;
    }
}

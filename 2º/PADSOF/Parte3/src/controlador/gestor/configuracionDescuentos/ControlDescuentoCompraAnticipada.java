...
import modelo.centroExposiciones.exposiciones.DescuentoCompraAnticipada;
...
public class ControlDescuentoCompraAnticipada implements ActionListener{

    private Ventana frame;
    private DescCompraAnticipada vista;
    private Sistema sistema;
    private CentroDeExposiciones centro;

    /*Los valores que toma cada descuento lo especificamos aqui? */
    public ControlDescuentoCompraAnticipada(Ventana frame, Sistema sistema){
        this.sistema = sistema;
        this.frame = frame;
        this.vista = frame.getVistaDescuentoCompraAnticipada();
    ...
    public void actionPerformed(ActionEvent e){
        if (e.getSource().equals(vista.getControladorConfirm())){
            ...
            if (vista.getPorcentaje() == -1.0 || vista.getDias() == -1){
            ...
            DescuentoCompraAnticipada desc = new DescuentoCompraAnticipada(vista.getPorcentaje(), vista.getDias()); 

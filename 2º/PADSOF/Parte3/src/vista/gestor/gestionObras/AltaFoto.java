 ...
 */
public class AltaFoto extends JPanel{
    ...
    public AltaFoto(Sistema sistema){
        ...
        String[] labels = {"Titulo de la obra:", "Autor: ", "Dueño: ", "Año: ", "Numero Seguro:", "Precio Seguro: ", "Estado: ", "Descripcion: ", "Temp. mínima", "Temp. máxima", "Hum. mínima", "Hum. máxima", "Ancho", "Largo", "Alto", "Diseño"};
        ...
        //fecha
        modelRandom = new SpinnerNumberModel(1, 1, 20, 1);
        ...
        //tecnica
        disenio = new JTextField();

        JComponent[] components = {titulo, autor, duenio, anio, seguro, precioSeguro, estado, descripcion, tempMin, tempMax, humMin, humMax, ancho, largo, alto, disenio};

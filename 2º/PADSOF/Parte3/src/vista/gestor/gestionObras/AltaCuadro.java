 ...
 */
public class AltaCuadro extends JPanel{
    ...
    public AltaCuadro(Sistema sistema){
        ...
        label1 = new JLabel("ALTA CUADROS");
        ...
        String[] labels = {"Titulo de la obra:", "Autor: ", "Dueño: ", "Año: ", "Numero Seguro:", "Precio Seguro: ", "Estado: ", "Descripcion: ", "Temp. mínima", "Temp. máxima", "Hum. mínima", "Hum. máxima", "Ancho", "Largo", "Alto", "Técnica"};
        ...
        JComponent[] components = {titulo, autor, duenio, anio, seguro, precioSeguro, estado, descripcion, tempMin, tempMax, humMin, humMax, ancho, largo, alto, tecnica};

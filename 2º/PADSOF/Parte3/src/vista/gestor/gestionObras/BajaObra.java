 ...
 */
public class BajaObra extends JPanel{
    ...
    public BajaObra(Sistema sistema){
        /*Establecemos layout de este panel */
        this.setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));

        /*PANEL SUPERIOR */
        panelSuperior = new JPanel();
        label1 = new JLabel("BAJA OBRA");
        ...
        String[] labels = {"Seleccionar obra:"};

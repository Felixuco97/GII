 ...
 */
public class GestionDeEmpleados extends JPanel {
    ...
    public GestionDeEmpleados(Sistema sistema){
        ...
        label1 = new JLabel("GESTIÓN   DE  EMPLEADOS");
        ...
        button1 = new JButton("Dar de alta empleado");
        button2 = new JButton("Gestion de permisos de empleados");
        button3 = new JButton("Gestion de contraseñas");
    ...
    public JButton getControladorAltaEmpleado(){
        return  button1;
    }

    public JButton getControladorGestPermisos(){
        return button2;
    }

    public JButton getControladorGestContrasenia(){
        return button3;
    }

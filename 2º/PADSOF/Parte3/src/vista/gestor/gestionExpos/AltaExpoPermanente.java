 ...
 */
public class AltaExpoPermanente extends JPanel{
    ...
    public AltaExpoPermanente(Sistema sistema){
        ...
        String[] labels = {"Titulo de la exposicion:", "Tipo de exposicion:", "Precio entradas: ", "Fecha de inicio: ", "Descuento:", "Numero de entradas: ", "Selecciona el estado: ", "Descripcion: ", "Descuento: "};
        ...
        //estado expo
        String ests[] = {"Programada", "Cancelada", "Cierre temporal", "En almacen", "En curso"};    
        ...
        JComponent[] components = {titulo, tipo, precio, fechaInicio, desc, nEntradas,estado, descripcion, panelDescuentos};
    ...
    public int getDiasAntelacion() {
        return Integer.parseInt(diasAntelacion.getText());
    }


    public double getPorcentajeClienteFrecuente(){ 
        return Double.parseDouble(porcentajeClienteFrecuente.getText());
    }

    public double getPorcentajeCompraAnticipada(){ 
        return Double.parseDouble(porcentajeCompraAnticipada.getText());
    }

    public int getVisitas() {
        return Integer.parseInt(visitas.getText());
    }

    public int getNumeroDias() {
        return Integer.parseInt(numeroDias.getText());
    }

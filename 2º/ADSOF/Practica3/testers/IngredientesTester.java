...
public class IngredientesTester {
    ...
    public Map<String, Ingrediente> crearIngredientes(){
        ...
        ingredientes.put("Aceite", new Ingrediente("Aceite", "Grasa", new InfoNutricionalPeso(885, 0, 100, 12.81, 0, 0, 0, 2)));
        ...
        ingredientes.put("Caldo", new Ingrediente("Caldo", "Caldo", new InfoNutricionalPeso(267, 18, 14, 3.4, 17, 17, 0, 23.875)));
